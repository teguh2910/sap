                  ...
                  <div class="card-body">
                    <div id="input-container">
                      ...
                      <div class="form-group row">
                        <select class="form-control col-md-4 select2" name="id_gudang_dua_0">
...
<script>
  ...
  function addInput() {
    ...
    partNoSelect.className = "form-control col-md-4 select2";
    ...
    removeBtn.className = "btn btn-danger col-md-2";
