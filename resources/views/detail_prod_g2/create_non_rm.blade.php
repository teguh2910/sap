...
@section('content')
    ...
    <div class="content-header">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Create Data Additive Gudang Satu</h1>            
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Create Data Qty Additive Gudang Dua</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">          
          ...
          <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form Create Data Qty Additive Gudang Dua</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ asset('detailprodg2/create') }}" enctype="multipart/form-data" method="POST">
                {{ csrf_field() }}
                <input type="hidden" name="id_prod_g2" value="{{ $id_prod_g2 }}">
                <div class="card card-primary">
                  <div class="card-body">
                  ...
                  <div class="card-footer">
                    <button type="submit" name="non_rm_submit" value="non_rm_submit" class="btn btn-primary">Next</button>
                  </div>
                </div>
              </form>
            </div>
