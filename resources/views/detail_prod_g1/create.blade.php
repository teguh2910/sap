        ...
        <div class="row">          
          ...
          <div class="card card-primary">
              ...
              <form action="{{ asset('detailprodg1/create') }}" enctype="multipart/form-data" method="POST">
                {{ csrf_field() }}
                <input type="hidden" name="id_prod_g1" value="{{ $prod_g1->id_prod_g1 }}">
                <div class="card card-primary">
                  <div class="card-body">
                  ...
                  <div class="card-footer">
                    <button type="submit" name="submit_rm" value="submit_rm" class="btn btn-primary">Next</button>
                  </div>
                </div>
              </form>
            </div>
