...
Route::put('/bank/edit/{id}', 'bankController@update');
...
Route::put('/part/edit/{id}', 'partController@update');
...
Route::put('/po/edit/{id}', 'poController@update');
...
Route::put('/top/edit/{id}', 'topController@update');
...
Route::put('/truk/edit/{id}', 'trukController@update');
